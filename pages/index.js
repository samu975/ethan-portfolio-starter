...
import PartickesContainer from "../components/ParticlesContainer";
  ...
  return (
    <div className="bg-primary/60 h-full">
      ...
      <div className="w-[1200px] h-full absolute right-0 bottom-0">
        ...
        <div>Particles</div>
        <div className="w-full h-full max-w-[537px] max-h-[478px] absolute -bottom-20 lg:bottom-10 lg:right-[8%]">
          <Avatar />
        </div>
      </div>
    </div>
